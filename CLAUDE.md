...
```bash
cd umbrella-integration/umbrella-typescript
mvn clean install
...
├── umbrella-integration/      # Client integration libraries
...
**umbrella-java**: Core Java client with HTTP communication logic
...
3. Regenerate clients: Build integration modules (e.g., `cd umbrella-integration/umbrella-typescript && mvn clean install`)
